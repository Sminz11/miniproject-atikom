...
export class UploadService {
  ...
  retryDetail(uploadId: number, detailId: number): Observable<any> {
    return this.http.post(`${this.apiUrl}/uploads/${uploadId}/details/${detailId}/retry`, {});
  }

  exportCSV(uploadId: number): Observable<Blob> {
    return this.http.get(`${this.apiUrl}/uploads/${uploadId}/details/export`, {
      responseType: 'blob'
    });
  }
